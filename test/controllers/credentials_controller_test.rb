...
class CredentialsControllerTest < ActionController::TestCase
  ...
  test "should create credential" do
    assert_difference('Credential.count') do
      post :create, credential: { certifications_id: @credential.certifications_id, credentials_id: @credential.credentials_id, user_id: @credential.user_id }
    end
  ...
  test "should update credential" do
    patch :update, id: @credential, credential: { certifications_id: @credential.certifications_id, credentials_id: @credential.credentials_id, user_id: @credential.user_id }
    assert_redirected_to credential_path(assigns(:credential))
  end
